...
Algoritms darbojas šādi: tiek inicializētas noliktavu koordinātas un piegādes punktu atrašanās vietas katrai noliktavai. Tiek noteikts kurjeru darba dienas sākuma un beigu laiks. Katrs noliktava tiek apstrādāta neatkarīgi, un piegādes punkti tiek piešķirti kurjeriem iteratīvā procesā, kas tiek vadīts ar noteiktiem ierobežojumiem un prioritātēm. Ja visi pasūtījumi tiek veiksmīgi iekļauti maršrutā, programma izvada optimizētos maršrutus un tiem atbilstoši piešķirtos kurjerus, nodrošinot, ka katrs pasūtījums tiek piegādāts savlaicīgi. Tiek sniegta detalizēta informācija par kurjeru piešķiršanu un piegādes plānu, kā arī aprēķināts kopējais nobrauktais attālums un piegādes laiks.

Tomēr, ja neizdodas iekļaut visus pasūtījumus maršrutā (piemēram, laika ierobežojumu vai citu iemeslu dēļ), programma saglabā jau izveidotos maršrutus un norāda pasūtījumus, kuri palikuši neiekļauti. Šie neiekļautie pasūtījumi tiek skaidri izcelti, lai lietotājs varētu tos pārskatīt un, ja nepieciešams, veikt papildu pasākumus vai piešķirt tos citiem kurjeriem vai laikiem.

Šāda pieeja nodrošina elastību un pārskatāmību loģistikas procesā, palīdzot efektīvi plānot resursus un maksimāli samazināt neizpildīto pasūtījumu skaitu.Galvenais mērķis ir piešķirt uzdevumus kurjeriem tādā veidā, lai pēc iespējas vairāk piegāžu tiktu veikti laicīgi, minimizējot attālumu un laiku.
